...
export default function Mission() {
    return (
        <div className="home__what-we-do">
            ...
            <p className="home__what-we-do-explanation p-xl l">From first-timers to professionals, StudioME offers media creators access to user-friendly studio spaces, equipment rentals, editing workstations, and custom production services. The StudioME model was created with the challenge to deliver high quality content using brand new approaches to an outdated, over-priced model. Keeping our promise of "Media Made Easy," we make it as simple as possible to go from concept to creation.</p>
