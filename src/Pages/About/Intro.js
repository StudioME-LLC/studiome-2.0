    ...
    return (
        <React.Fragment>
                ...
                <div className="about__intro-story-container">
                    ...
                    <p className="about__intro-story-1">Monthly StudioME memberships will soon be available for those who need to create scalable media content on a regular basis.</p>
