    ...
    return (
        <React.Fragment>
                ...
                <div className="about__intro-story-container">
                    ...
                    <p className="about__intro-story-1">StudioME is a user-friendly space for media production that opened its doors in 2016 by co-founders, Keith Parish and Joe Leachko. Noticing the changing media landscape, they created StudioME to be a more efficient resource for media production. They took the traditional studio model and redesigned it to offer user-friendly DIY services for new content creators as well as more efficient, cost-effective solutions for media professionals. Since opening, the StudioME team has been able to achieve millions of views for their clients. Monthly StudioME memberships will soon be available for those who need to create scalable media content on a regular basis.</p>
